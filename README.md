# ⚛️ a fork of `gatsby-starter-strict`

(it's slightly less strict and has chakra and some other deps set-up)

A Gatsby starter with strict linting and auto-formatting rules.

## 🚀 Getting started

- Clone this project and install all the required dependencies _(e.g. with `npx gatsby new gatsby-example-site https://github.com/PTaylour/gatsby-starter-typescript-chakra`)_
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/ptaylour/gatsby-starter-strict)
